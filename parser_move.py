...
with open('move.csv', 'w') as csvfile:
	...
	fieldnames = ['title', 'address', 'price', 'count_rooms', 'floor', 'type_obj', 'square', 'publication_date', 'link', 'images']
	...
	while count <= n:  # count <= n
		try:
			...
			csv_table = {'title':title, 'address':address, 'price':price, 'count_rooms':count_rooms, 'floor':floor, 'type_obj':type_obj, 'square':square, 'publication_date':publication_date, 'link':link, 'images':images}
