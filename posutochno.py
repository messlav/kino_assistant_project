...
with open('posutochno.csv', 'w') as csvfile:
    ...
    while count <= n:
        try:
            ...
            csv_table = {'title':title, 'address':address, 'price':price, 'count_rooms':rooms, 'floor':floor, 'type_obj':type_obj, 'square':square, 'publication_date':publication_date, 'link':link, 'images':images, 'metro':metro, 'phone':real_phone}
